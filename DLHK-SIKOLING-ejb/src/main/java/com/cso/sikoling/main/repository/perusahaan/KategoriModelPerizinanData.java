...
public class KategoriModelPerizinanData implements Serializable {
    ...
    public KategoriModelPerizinanData() {
    }

    public KategoriModelPerizinanData(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof KategoriModelPerizinanData)) {
            return false;
        }
        KategoriModelPerizinanData other = (KategoriModelPerizinanData) object;
    ...
    public String toString() {
        return "com.cso.sikoling.main.repository.perusahaan.KategoriModelPerizinanData[ id=" + id + " ]";
    }
